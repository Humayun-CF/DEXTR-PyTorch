...
import dataloaders.prostate as prostate
...
if resume_epoch != nEpochs:
    ...
    voc_train = prostate.ProstateSegmentation(split='train', transform=composed_transforms_tr)
    voc_val = prostate.ProstateSegmentation(split='val', transform=composed_transforms_ts)
...
composed_transforms_ts = transforms.Compose([
    ...
    tr.ConcatInputs(elems=('crop_image', 'extreme_points')),
    tr.ToTensor()])
db_test = prostate.ProstateSegmentation(split='val', transform=composed_transforms_ts, retname=True)
